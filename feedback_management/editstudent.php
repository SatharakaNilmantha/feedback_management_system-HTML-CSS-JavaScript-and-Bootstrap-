...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    if (!isset($_GET['id'])) {
        header('location:/feedback_management/sreport.php');
        exit;
    }
...
else 
{
    ...
    do {
        $sql = "UPDATE student SET User_Name = '$User_Name', Password = '$Password', First_Name = '$First_Name', Last_Name = '$Last_Name', Registration_No = '$Registration_No', Date_of_Birth = '$Date_of_Birth', Address = '$Address',Batch='$Batch',Academic_Year='$Academic_Year' WHERE Id = '$Id';";
        $result = $connection->query($sql);
        ...
        $sql1 = "UPDATE student_register SET  Password = '$Password' WHERE User_Name = '$User_Name';";
        ...
        $successMessage = "Lecture updated correctly";
   ...
   <body class="body">
    ...
    <div class="container border" style="background-color: rgba(123, 115, 231, 0.095);padding-bottom: 20px;">    
           ...
           <div>
                ...
                <div >
                    <img class="back-image my-3 " src="image/addstudent.jpg" alt="">
                    <h1 class="cont-title container">UPDATE STUDENT </h1>
                </div>
                ...
                <div >
                  <div class=" row   "style="margin-bottom:50px">
                    ...
                    <div class=" col-7 ms-5 font">
                        <div width="760" height="470"  ><img  style="box-shadow: 5px 10px 18px #888888;  padding-left: 160px; padding-right: 130px; padding-top: 5px; padding-bottom: 5px;" src="icon/logo1.png" alt=""></div>
                        <iframe width="760" height="470" style="box-shadow: 5px 10px 18px #888888; margin-top: 30px;" src="https://www.youtube.com/embed/qLloNbxWoN0?si=ovDWxqaGHJ0xG0hb" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                      <div class="row">
                    ...
                    <div class=" form-style container border col-4  py-3 font" id="myForm" style="box-shadow: 5px 10px 18px #888888; ">
                        <form  class="form-container" method="post" >
                          ...
                          <h2 style="text-align: center;"><em>Enroll student</em></h2>
                          ...
                          <input type="text" class="form-control  " placeholder="Enter id" name="id" value="<?php echo $Id; ?>" required>
                          ...
                          <label for="dob" class="  py-3"><b>Date of birth :</b></label>
                          <input type="date" class="form-control "name="dob" value="<?php echo $Date_of_Birth; ?>" required>

                          <label for="address" class="  py-3"><b>Address :</b></label>
                          <input type="text" class="form-control " placeholder="Enter your Address..." name="address" value="<?php echo $Address; ?>" required>
        

                          <label for="regno" class="  py-3"><strong>Registration Number:</strong></label>
                          <input type="text" class="form-control "  id="reg"  placeholder="Enter registration number" name="reg" value="<?php echo $Registration_No; ?>" required>
                          ...
                          <label for="acadamic" class="  py-3"><b>Acadamic Year :</b></label>
                          <p >
                            <select class="form-control" name="year" value="<?php echo $Academic_Year; ?>">
                        ...
                        <label for="batch" class="  py-3"><strong>Batch :</strong></label>
                        <input type="text" class="form-control  "  placeholder="example = 1 batch" name="batch" value="<?php echo $Batch; ?>" required>
