...
<html >
    <head>
    <title>lecture feedback manage</title>
   ...
   <body class="body">
            ...
            <nav class="navbar navbar-expand-sm  navbar-dark container nav" style="background-color:#07075ca7;height: 80px;">
                    ...
                    <form class="d-flex col-3" method="post" action="">
                      <input class="form-control me-2" type="search" placeholder="Search by Reg.No/Lec_Name/Sem" name="search" aria-label="Search">
  ...
  <div class="container border" style="background-color: rgba(123, 115, 231, 0.06);padding-bottom: 20px;">    
        ...
        <h1 class="font py-5" style="text-align: center;">LIST OF LECTURE FEEDBACK</h1>
                  ...
                  <tbody>
                    ...
                    <?php
                        ...
                        if (isset($_POST['submit']) && !empty($_POST['search'])) {
                            ...
                            $sql = "SELECT student.Registration_No, lecture_feedback.Id, lecture_feedback.Semester, lecture_feedback.Lecture_Name 
                                    FROM lecture_feedback 
                                    INNER JOIN student ON lecture_feedback.User_Name = student.User_Name
                                    WHERE student.Registration_No LIKE '%$search%' OR lecture_feedback.Lecture_Name  LIKE '%$search%' OR  lecture_feedback.Semester LIKE '%$search%' 
                                    ORDER BY student.Registration_No ASC, lecture_feedback.Semester ASC";
                        } else 
                        {
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class='btn btn-primary  col' href='viewlecfeedback.php?id={$row['Id']}'>View</a>
                                            <a class='btn btn-danger col-3' href='deletelecfeedback.php?id=$row[Id]' onclick='return confirmDelete();'>Delete</a>
                                        </td>
                                    </tr>
                                    ";
                                }
