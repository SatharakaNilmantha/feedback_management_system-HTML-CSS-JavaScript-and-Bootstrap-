...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($User_Name) || empty($Password)) {
        ...
        $Statement = $connection->prepare(
            "SELECT id, First_Name, Last_Name, User_Name, Password FROM lecture_register WHERE User_Name = ? AND Password = ?"
        );
        ...
        <div class=" row container my-3  "style="margin-bottom:50px ;padding-bottem:40px">
              ...
              <div class=" form-style container border col-5 ms-5 py-2 my-1" id="myForm" style="box-shadow: 5px 10px 18px #888888;">
                 ...
                 <div>
                    ...
                    <a class="btn btn-primary col-3  butt2" href="register2.php" role="button">Register</a>
