<?php
   ...
   if ($_SERVER['REQUEST_METHOD']=='POST')
   {
        ...
        do{
            ...
            // add new maneger to database
       
            $sql="INSERT INTO student VALUES('$Id','$User_Name','$Password','$First_Name','$Last_Name','$Registration_No','$Date_of_Birth','$Address','$Batch','$Academic_Year');";
    ...
    <div class="container border" style="background-color: rgba(123, 115, 231, 0.095);padding-bottom: 20px;">    
           ...
           <div>
                ...
                <div >
                    ...
                    <h1 class="cont-title container">ADD NEW STUDENT</h1>
                </div>
                  ...
                  <div class=" row   "style="margin-bottom:50px">
                    ...
                    <div class=" form-style container border col-4  py-3 font" id="myForm" style="box-shadow: 5px 10px 18px #888888; ">
                        <form  class="form-container" method="post" >
                          ...
                          <input type="address" class="form-control " placeholder="Enter your Address..." name="address" value="<?php echo $Address; ?>" required>
