...
if (isset($_GET["id"])) {
    ...
    $sqlFetch = "SELECT User_Name FROM management_assistant WHERE id = ?";
    ...
    $sqlDeleteMA = "DELETE FROM management_assistant WHERE id = ?";
    ...
    $sqlDeleteAR = "DELETE FROM assistant_register WHERE User_Name = ?";
    ...
    header('Location: http://localhost/feedback_management/mreport.php');
    exit;
