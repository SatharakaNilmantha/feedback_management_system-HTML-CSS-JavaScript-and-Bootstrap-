...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    if (!isset($_GET['id'])) {
        header('location:/feedback_management/lecreport.php');
        exit;
    }
    ...
    $Course = $row["Course"];
    $Outlook_Address = $row["Outlook_Address"];
 ...
 else 
 {
    ...
    do {
        $sql = "UPDATE lecture SET User_Name = '$User_Name', Password = '$Password', First_Name = '$First_Name', Last_Name = '$Last_Name', Department = '$Department', Course = '$Course', Outlook_Address = '$Outlook_Address' WHERE Lecture_Id = '$Lecture_Id';";
        $result = $connection->query($sql);
        ...
        $sql1 = "UPDATE lecture_register SET Password = '$Password' WHERE User_Name = '$User_Name';";
    ...
    <div class="container border" style="background-color: rgba(123, 115, 231, 0.095);padding-bottom: 20px;">    
           ...
           <div>
                ...
                <div >
                    ...
                    <h1 class="cont-title container">UPDATE THE LECTURE</h1>
                </div>
                  ...
                  <div class=" row   "style="margin-bottom:50px">
                    ...
                    <div class=" form-style container border col-4  py-3 font" id="myForm" style="box-shadow: 5px 10px 18px #888888; ">
                        <form  class="form-container" method="post" >
                          ...
                          <input type="text" class="form-control  " placeholder="Enter id" name="id" value="<?php echo $Lecture_Id; ?>" >


                         
                          <label for="uname" class="  py-3"><strong>User Name :</strong></label>
                          <input type="text" class="form-control  "  placeholder="Enter your user name...." name="uname" value="<?php echo $User_Name; ?>" >

                          <label for="address" class="  py-3"><b>Outlook Address :</b></label>
                          <input type="text" class="form-control " placeholder="example@gmail.com"  name="address" value="<?php echo  $Outlook_Address; ?>" >
                        ...
                        <input type="text" class="form-control  "  placeholder="courses" name="course" value="<?php echo $Course; ?>" >
