...
<html >
    ...
    <link rel="stylesheet" type="text/css" href="css/mreport.css">
   ...
   <body class="body">
            ...
            <nav class="navbar navbar-expand-sm  navbar-dark container nav" style="background-color:#07075ca7;height: 80px;">
                    ...
                    <form class="d-flex col-3" method="post" action="">
                      <input class="form-control me-2" type="search" placeholder="Search by Man.ID  or  Name" name="search" aria-label="Search">
  ...
  <div class="container border" style="background-color: rgba(123, 115, 231, 0.075);padding-bottom: 20px;">  
        ...
        <div >
            <h1 class="cont-title container ">REPORT OF ASS.MANAGER</h1>
        </div>
                    ...
                    <table class="table table-bordered">
                      ...
                      <?php
                          ...
                          if (isset($_POST['submit']) && !empty($_POST['search'])) {
                              ...
                              $sql = "SELECT id, First_Name, Last_Name, User_Name FROM management_assistant WHERE First_Name LIKE '%$search%' OR Last_Name LIKE '%$search%' OR id LIKE '%$search%'";
                          } else {
                              // Default query to display all courses
                              $sql = "SELECT id, First_Name, Last_Name, User_Name FROM management_assistant";
                          }
                          ...
                          if ($result->num_rows > 0) {
                              ...
                              while ($row = $result->fetch_assoc()) {
                                  ...
                                  <tr>
                                      ...
                                      <td>$row[User_Name]</td>
                                      <td>
                                          <a class='btn btn-success col-3' href='editmanager.php?id=$row[id]'>Edit</a>
                                          <a class='btn btn-danger col-3' href='deletemanager.php?id=$row[id]' onclick='return confirmDelete();'>Delete</a>
                                      </td>
                                  </tr>
                                  ";
                              }
