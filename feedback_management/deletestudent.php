...
if (isset($_GET["id"])) {
    ...
    $sqlFetch = "SELECT User_Name FROM student WHERE id = ?";
    ...
    $sqlDeleteMA = "DELETE FROM student WHERE id = ?";
    ...
    $sqlDeleteAR = "DELETE FROM student_register WHERE User_Name = ?";
    ...
    header('Location: http://localhost/feedback_management/sreport.php');
    exit;
