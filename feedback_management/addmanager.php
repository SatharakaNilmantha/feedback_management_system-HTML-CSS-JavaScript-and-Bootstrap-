<?php
   ...
   if ($_SERVER['REQUEST_METHOD']=='POST')
   {
        ...
        do{
            ...
            $sql="INSERT INTO management_assistant VALUES('$id','$User_Name','$Password','$First_Name','$Last_Name');";
    ...
    <div class="container border" style="background-color: rgba(123, 115, 231, 0.095);padding-bottom: 20px;">    
           ...
           <div>
                ...
                <div >
                    ...
                    <h1 class="cont-title container">ADD NEW MANAGEMENT ASSISTANT</h1>
                </div>
                  ...
                  <div class=" row   "style="margin-bottom:50px">
                    ...
                    <div class=" form-style container border col-4  py-3 font" id="myForm" style="box-shadow: 5px 10px 18px #888888; ">
                        <form  class="form-container" method="post">
                          ...
                          <input type="text" class="form-control " placeholder="Enter your id...." name="id" value="<?php echo $id; ?>" required>
                          ...
                          <div class="py-4" >
                          <button type="submit" class="btn btn-primary col-4  butt1">Submit</button>
